...
?>
	...
	<div class="main-container">
            ...
            <h4 class="padding-top-30 mb-30 weight-500 update_title d-none"><?php echo $page_update_title; ?></h4>
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label for="InputEcoScoreName"><?php echo $page_name; ?></label>
                    <input class="form-control AddEcoScoreFormName" id="InputEcoScoreName" type="text" name="name" placeholder="<?php echo $page_name; ?>">
                  </div>
                </div>

                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label for="InputEcoScoreColor"><?php echo $page_color; ?></label>
                    <input type="text" class="colorpicker form-control AddEcoScoreFormColor" id="InputEcoScoreColor" placeholder="<?php echo $page_color; ?>" name="color" value="" />
                  </div>
                </div>
              ...
              <div class="padding-bottom-30 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnAddEcoScore" data-dismiss="modal" id="btnAddEcoScore"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_confirm; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      <script src="jsDistrix/foodEcoScore.js"></script>
  </body>
</html>