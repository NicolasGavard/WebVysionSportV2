...
// RestoreScoreEco
if ($dataSvc->getMethodName() == "RestoreScoreEco") {
  $dbConnection = null;
  $errorData    = null;
  $insere       = false;
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("Distrix", "RestoreScoreEco", $dataSvc->getMethodName(), basename(__FILE__));
