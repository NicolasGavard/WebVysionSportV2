...
if (is_null($dbConnection->getError())) {
  ...
  $labelStor  = LabelStor::read($data->getId(), $dbConnection);
  $infoLabel  = DistriXSvcUtil::setData($labelStor, "DistriXFoodLabelData");
...
$dataSvc->addToResponse("ViewLabel", $infoLabel);
