...
// RestoreApplication
if ($dataSvc->getMethodName() == "RestoreApplication") {
  $dbConnection = null;
  $errorData    = null;
  $insere       = false;
  ...
  if (is_null($dbConnection->getError())) {
    if ($dbConnection->beginTransaction()) {
      ...
      $insere       = StyApplicationStor::restore($styApplicationstor, $dbConnection);
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "RestoreApplication", $dataSvc->getMethodName(), basename(__FILE__));
