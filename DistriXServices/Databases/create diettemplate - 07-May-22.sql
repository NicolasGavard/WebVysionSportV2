...
CREATE TABLE `diettemplate` (
  ...
  PRIMARY KEY (`id`),
  KEY `inddiettemplate` (`idusercoatch`),
  UNIQUE KEY `inddietunique` (`idusercoatch`,`name`,`duration`) USING BTREE
) ENGINE=InnoDB COMMENT='Diet Template' DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;

INSERT INTO diettemplate(id,idusercoatch,name,duration,tags,elemstate,timestamp) VALUES 
