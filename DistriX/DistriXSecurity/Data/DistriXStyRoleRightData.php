...
if (!class_exists("DistriXStyRoleRightData", false)) {
  class DistriXStyRoleRightData extends DistriXSvcAppData
  {
    ...
    public function getDescriptionApplication(){return $this->descriptionApplication;}
    public function getIdStyModule(){return $this->idStyModule;}
    public function getCodeModule(){return $this->codeModule;}
    public function getDescriptionModule(){return $this->descriptionModule;}
    ...
    public function getDescriptionFunctionality(){return $this->descriptionFunctionality;}
    ...
    public function setDescriptionApplication($descriptionApplication){$this->descriptionApplication = $descriptionApplication;}
    ...
    public function setDescriptionModule($descriptionModule){$this->descriptionModule = $descriptionModule;}
    ...
    public function setDescriptionFunctionality($descriptionFunctionality){$this->descriptionFunctionality = $descriptionFunctionality;}
