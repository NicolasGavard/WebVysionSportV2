...
// RestoreModule
if ($dataSvc->getMethodName() == "RestoreModule") {
  $dbConnection = null;
  $errorData    = null;
  $insere       = false;
  ...
  if (is_null($dbConnection->getError())) {
    if ($dbConnection->beginTransaction()) {
      ...
      $insere         = StyModuleStor::restore($styModuleStor, $dbConnection);
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "RestoreModule", $dataSvc->getMethodName(), basename(__FILE__));
