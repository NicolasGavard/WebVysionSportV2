...
if (is_null($dbConnection->getError())) {
  ...
  $styRolestor = StyRoleStor::read($data->getId(), $dbConnection);
  $infoRole    = DistriXSvcUtil::setData($styRolestor, "DistriXStyRoleData");
} else {
...
$dataSvc->addToResponse("ViewRole", $infoRole);
