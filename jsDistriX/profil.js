// Load Languages
$(".page_profil_title").text(language.page_profil_title);
$(".page_profil_title_settings").text(language.page_profil_title_settings);
$(".page_profil_title_tasks").text(language.page_profil_title_tasks);
$(".page_profil_title_change_pass").text(language.page_profil_title_change_pass);

$(".page_profil_title_presentation").text(language.page_profil_title_presentation);
$(".page_profil_full_name").text(language.page_profil_full_name);
$(".page_profil_login").text(language.page_profil_login);
$(".page_profil_login").attr("placeholder", language.page_profil_login);
$(".page_profil_role").text(language.page_profil_role);
$(".page_profil_role").attr("placeholder", language.page_profil_role);
$(".page_profil_name").text(language.page_profil_name);
$(".page_profil_name").attr("placeholder", language.page_profil_name);
$(".page_profil_firstname").text(language.page_profil_firstname);
$(".page_profil_firstname").attr("placeholder", language.page_profil_firstname);
$(".page_profil_gender").text(language.page_profil_gender);
$(".page_profil_female").text(language.page_profil_female);
$(".page_profil_male").text(language.page_profil_male);
$(".page_profil_address1").text(language.page_profil_address1);
$(".page_profil_address2").text(language.page_profil_address2);
$(".page_profil_country").text(language.page_profil_country);
$(".page_profil_country").attr("placeholder", language.page_profil_country);
$(".page_profil_country").attr("title", language.page_profil_country);
$(".page_profil_zip_code").text(language.page_profil_zip_code);
$(".page_profil_zip_code").attr("placeholder", language.page_profil_zip_code);
$(".page_profil_city").text(language.page_profil_city);
$(".page_profil_city").attr("placeholder", language.page_profil_city);
$(".page_profil_email").text(language.page_profil_email);
$(".page_profil_email").attr("placeholder", language.page_profil_email);
$(".page_profil_emailBackup").text(language.page_profil_emailBackup);
$(".page_profil_emailBackup").attr("placeholder", language.page_profil_emailBackup);
$(".page_profil_date_of_birth").text(language.page_profil_date_of_birth);
$(".page_profil_date_of_birth").attr("placeholder", language.page_profil_date_of_birth);
$(".page_profil_phone").text(language.page_profil_phone);
$(".page_profil_phone").attr("placeholder", language.page_profil_phone);
$(".page_profil_mobile").text(language.page_profil_mobile);
$(".page_profil_mobile").attr("placeholder", language.page_profil_mobile);
$(".page_profil_notifier").text(language.page_profil_notifier);
$(".page_profil_langue").text(language.page_profil_langue);
$(".page_profil_photo_profil").text(language.page_profil_photo_profil);

$(".page_profil_social_links").text(language.page_profil_social_links);
$(".page_profil_edit_settings").text(language.page_profil_edit_settings);

$(".page_profil_title_2").text(language.page_profil_title_2);
$(".page_profil_update_title").text(language.page_profil_update_title);
$(".page_profil_old_pass").text(language.page_profil_old_pass);
$(".page_profil_old_pass").attr("placeholder", language.page_profil_old_pass);
$(".page_profil_new_pass").text(language.page_profil_new_pass);
$(".page_profil_new_pass").attr("placeholder", language.page_profil_new_pass);
$(".page_profil_confirm_pass").text(language.page_profil_confirm_pass);
$(".page_profil_confirm_pass").attr("placeholder", language.page_profil_confirm_pass);
$(".page_profil_change_pass_title").text(language.page_profil_change_pass_title);
