...
if (is_null($dbConnection->getError())) {
  if ($dbConnection->beginTransaction()) {
    ...
    $insere                         = ExerciseMuscleStor::restore($exerciseMuscleStorData, $dbConnection);
    if ($insere) {
      $dbConnection->commit();
    } else {
...
if ($errorData != null) {
  $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "RestoreCurrentExerciseMuscle", $dataSvc->getMethodName(), basename(__FILE__));
