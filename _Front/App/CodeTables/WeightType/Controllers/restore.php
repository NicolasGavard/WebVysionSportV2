...
if (isset($_POST)) {
  ...
  $servicesCaller->setServiceName("App/CodeTables/WeightType/Services/DistriXWeightTypeRestoreDataSvc.php");
  list($outputok, $output, $errorData) = $servicesCaller->call(); 
  // print_r($output);

  $logOk = logController("Security_WeightType", "DistriXWeightTypeRestoreDataSvc", "RestoreWeightType", $output);
