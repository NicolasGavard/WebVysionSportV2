...
if (isset($_POST)) {
  ...
  $servicesCaller->setServiceName("App/CodeTables/SportExerciseType/Services/DistriXExerciseTypeDeleteDataSvc.php");
  list($outputok, $output, $errorData) = $servicesCaller->call(); 
  //print_r($output);

  $logOk = logController("Security_ExerciseType", "DistriXExerciseTypeDeleteDataSvc", "DelExerciseType", $output);
