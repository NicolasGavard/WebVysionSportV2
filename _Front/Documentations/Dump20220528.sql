...
CREATE TABLE `brand` (
  ...
  `linktopicture` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `brand` VALUES (1,'CRISTALINE','Cristaline','',0,'',0,0),(2,'LU','Lu','',0,'',0,2);
...
INSERT INTO `diet` VALUES (1,1,1,20220520,0,0),(2,1,2,20220520,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Food Weight';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `label` VALUES (1,'BIO','Bio','',0,'',0,0),(2,'ECOCERT','Ecocert','',0,'',0,0),(3,'BIO_EUROPEEN','Bio européen','',0,'',0,0),(4,'FR-BIO-01','FR-BIO-01','',0,'',0,0),(5,'MADE_IN_FRANCE','Fabriqué en France','',0,'',0,0),(6,'AB_AGRI_BIO','AB Agriculture Biologique','',0,'',0,0);
...
CREATE TABLE `language` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `codeshort` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `indcodeunique` (`code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Languages';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nutritional` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `indcodeunique` (`code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Nutritional';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nutritionalname` (
  ...
  KEY `indlanguage` (`idlanguage`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Nutritional Names';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `scoreeco` VALUES (1,'?','B3B3B3','?','',0,'',0,0),(2,'A','208E51','A','',0,'',0,0),(3,'B','5FAE31','B','',0,'',0,0),(4,'C','E7B40B','C','',0,'',0,0),(5,'D','E47323','D','',0,'',0,0),(6,'E','EF131F','E','',0,'',0,0);
...
INSERT INTO `scorenova` VALUES (1,'?','B3B3B3','?','',0,'',0,0),(2,'1','00A501','1','',0,'',0,0),(3,'2','F7C600','2','',0,'',0,0),(4,'3','F76300','3','',0,'',0,0),(5,'4','F60000','4','',0,'',0,0);
...
INSERT INTO `scorenutri` VALUES (1,'?','B3B3B3','?','',0,'',0,0),(2,'A','0A8E45','A','',0,'',0,0),(3,'B','7AC547','B','',0,'',0,0),(4,'C','FFC734','C','',0,'',0,0),(5,'D','FF7D24','D','',0,'',0,0),(6,'E','FF421A','E','',0,'',0,0);
...
CREATE TABLE `styenterpisewhitemarking` (
  ...
  `logo1` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `logo2` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `color1` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `color2` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `elemstate` tinyint unsigned NOT NULL,
  `timestamp` int unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-05-28 21:02:09
