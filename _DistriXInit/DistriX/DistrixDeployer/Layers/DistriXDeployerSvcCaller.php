...
if (!class_exists('DistriXDeployerSvcCaller', false)) {
	class DistriXDeployerSvcCaller extends DistriXSvcCaller
	{
		/* SSL Keys Locations */
		...
		const CLIENT_DIR_DEV     = "DistriXWebSite";
		const CLIENT_DIR_INT     = "DeployerServices";
		const CLIENT_DIR_VER     = "DeployerServices";
		const CLIENT_DIR_VAL     = "DeployerServices";
		const CLIENT_DIR_PROD    = "DeployerServices";
