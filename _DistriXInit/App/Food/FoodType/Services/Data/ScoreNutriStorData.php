...
// Gets
  ...
  public function isAvailable():int { return ($this->elemstate == self::SCORENUTRI_STATUS_AVAILABLE); }
  public function getAvailableValue():int { return self::SCORENUTRI_STATUS_AVAILABLE; }
  public function getUnavailableValue():int { return self::SCORENUTRI_STATUS_NOT_AVAILABLE; }
// Sets
