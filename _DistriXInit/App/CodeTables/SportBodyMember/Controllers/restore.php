...
if (isset($_POST)) {
  ...
  $servicesCaller->setServiceName("App/CodeTables/SportBodyMember/Services/DistriXBodyMemberRestoreDataSvc.php");
  list($outputok, $output, $errorData) = $servicesCaller->call(); 
  // print_r($output);

  $logOk = logController("Security_BodyMember", "DistriXBodyMemberRestoreDataSvc", "RestoreBodyMember", $output);
