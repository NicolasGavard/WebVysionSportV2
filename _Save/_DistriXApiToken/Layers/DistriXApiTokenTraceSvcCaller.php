...
if (!class_exists('DistriXApiTokenTraceSvcCaller', false)) {
	class DistriXApiTokenTraceSvcCaller extends DistriXSvcCaller
	{
		/* SSL Keys Locations */
		...
		const CLIENT_DIR_DEV     = "DistriX/TraceService";
		const CLIENT_DIR_INT     = "ApiToken";
		const CLIENT_DIR_VER     = "ApiToken";
		const CLIENT_DIR_VAL     = "ApiToken";
		const CLIENT_DIR_PROD    = "ApiToken";
		...
		const CLIENT_DIR_DEV_TIMEOUT              = "DistriX/TraceService";
