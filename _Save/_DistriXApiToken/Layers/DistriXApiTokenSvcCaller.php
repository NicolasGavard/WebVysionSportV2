...
if (!class_exists('DistriXApiTokenSvcCaller', false)) {
	class DistriXApiTokenSvcCaller extends DistriXSvcCaller
	{
		/* SSL Keys Locations */
		...
		const CLIENT_DIR_DEV     = "DISTRIX_APITOKEN/DistriX";
		...
		const CLIENT_DIR_DEV_TIMEOUT              = "DISTRIX_APITOKEN/DistriX";
