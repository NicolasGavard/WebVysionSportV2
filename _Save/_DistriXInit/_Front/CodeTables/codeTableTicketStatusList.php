<?php
session_start();
  $international  = 'CodeTables/codeTableTicketStatusList';
  $i18cdlangue    = 'FR';
  ...
  ?>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pb-20">
                  ...
                  <th><span><?php echo $page_action; ?></span></th>
							...
							<tbody id="listTicketStatussTbody">
							</tbody>
						</table>
					</div>
				</div>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddTicketStatusFormCode" type="text" code="codeShort" placeholder="<?php echo $page_code; ?>">
                ...
                <div class="col-md-6 col-sm-12">
                  <div class="form-group">
                    <label><?php echo $page_code; ?></label>
                    <input class="form-control AddTicketStatusFormName" type="text" code="foodTypeName" placeholder="<?php echo $page_name; ?>">
      ...
      ?>
      <script src="../../jsWebVysionSport/CodeTables/codeTableTicketStatus.js"></script>
  </body>
</html>
