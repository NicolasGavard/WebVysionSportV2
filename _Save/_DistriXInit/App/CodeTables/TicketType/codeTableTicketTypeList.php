<?php
  ...
  // If ($user->->getIdLanguage() == 2) $i18cdlangue = 'EN';
	...
	include('i18/'.$i18cdlangue.'/codeTableTicketTypeList'.$i18cdlangue.'.php');
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="pull-right">
              ...
              <button type="button" class="btn btn-primary AddNewTicketType" data-toggle="modal" data-target="#modalAddTicketType"><i class="fa fa-plus"></i>&nbsp;<?php echo $page_all_add; ?></button>
        		</div>
					</div>
          
          <div class="pb-20"></div>
          <div class="pb-20">
						<table id="TicketTypeTable" class="display responsive nowrap" width="100%">
							<thead>
								<tr>                 
      ...
      <div class="modal fade" id="modalAddTicketType" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-body text-center font-18">
              ...
              <input class="form-control AddTicketTypeFormIdTicketType" type="hidden" name="id"         value="0">
              <input class="form-control AddTicketTypeFormTimestamp"  type="hidden" name="timestamp"  value="0">
              <input class="form-control AddTicketTypeFormStatut"     type="hidden" name="elemState"  value="0">
              
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                    <label><?php echo $page_code; ?></label>
                    <input class="form-control AddTicketTypeFormCode" id="AddTicketTypeFormCode" type="text" code="codeShort" placeholder="<?php echo $page_code; ?>">
                ...
                <div class="col-md-8 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddTicketTypeFormName" id="AddTicketTypeFormName" type="text" code="ticketTypeName" placeholder="<?php echo $page_name; ?>">
              ...
              <div id="ticketTypeLanguages"></div>
              ...
              <div class="padding-bottom-20 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnAddTicketType" id="btnAddTicketType"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_add; ?></button>
                  <button type="button" class="btn btn-primary btnUpdateTicketType" id="btnUpdateTicketType"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_update; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      ?>
      <script src="codeTableTicketTypeList.js?v=<?php echo APP_VERSION;?>"></script>
  </body>
</html>
