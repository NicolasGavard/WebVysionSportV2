...
include(__DIR__ . "/../../Food/Data/DistriXFoodFoodData.php");
include(__DIR__ . "/../../Brand/Data/DistriXFoodBrandData.php");
include(__DIR__ . "/../../EcoScore/Data/DistriXFoodEcoScoreData.php");
include(__DIR__ . "/../../NovaScore/Data/DistriXFoodNovaScoreData.php");
include(__DIR__ . "/../../NutriScore/Data/DistriXFoodNutriScoreData.php");
...
$foodCaller->setServiceName("App/Food/Food/Services/DistriXFoodViewDataSvc.php");
