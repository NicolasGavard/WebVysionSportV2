...
const DATA_SRV_TEST = "www.gosmap.com";
const DATA_SRV_PROD = "192.168.255.255";
//const DATA_SRV_CALL = self::DATA_SRV_DEV;
const DATA_SRV_CALL = self::DATA_SRV_TEST;
...
const DATA_DIR_DEV = "DataServices";
const DATA_DIR_TEST = "Formulaires/DataServices";
const DATA_DIR_PROD = "DataServices";
//const DATA_DIR_CALL = self::DATA_DIR_DEV;
const DATA_DIR_CALL = self::DATA_DIR_TEST;
