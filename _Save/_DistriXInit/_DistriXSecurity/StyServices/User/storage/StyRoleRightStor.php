...
class StyRoleRightStor {

  public static function findByIndRoleGroupBy(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
    ...
    if ($inDbConnection != null) {
      ...
      $request .= " GROUP BY idstyapplication";
      $request .= " ORDER BY idstyapplication";
      $params = [];
      $params["index0"] = $dataIn->getIdStyRole();
      ...
      if ($stmt->rowCount() > 0) {
        $list = $stmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, "StyRoleRightStorData");
      }
    }
  ...
  public static function findByIndRoleAppGroupBy(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
    ...
    if ($inDbConnection != null) {
      ...
      $request .= " GROUP BY idstymodule";
      $request .= " ORDER BY idstymodule";
      $params = [];
      $params["index0"] = $dataIn->getIdStyRole();
  ...
  public static function findByIndRoleAppModuleGroupBy(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
    ...
    if ($inDbConnection != null) {
      ...
      $request .= " GROUP BY idstyfunctionality";
      $request .= " ORDER BY idstyfunctionality";
      $params = [];
      $params["index0"] = $dataIn->getIdStyRole();
      $params["index1"] = $dataIn->getIdStyApplication();
...
//=============================================================================
//=============================================================================
  const TABLE_NAME = "styRoleRight";
  const SELECT = 'SELECT id,idstyrole,idstyapplication,idstymodule,idstyfunctionality,sumofrights,timestamp';
  const FROM = ' FROM styRoleRight';
  ...
  public static function findByIndRole(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
  ...
  public static function findByIndRoleApp(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
  ...
  public static function findByIndRoleAppModule(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
  ...
  public static function findByIndRoleAppModuleFunc(StyRoleRightStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
  ...
  public static function read(int $id, DistriXPDOConnection $inDbConnection)
  {
    ...
    if ($inDbConnection != null) {
      ...
      if ($stmt->rowCount() > 0) {
        $stmt->setFetchMode(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, "StyRoleRightStorData");
        $data = $stmt->fetch();
      }
  ...
  public static function update(StyRoleRightStorData $data, $traceType, DistriXPDOConnection $inDbConnection)
  {
    $insere = false;
    $request = "";

    if ($inDbConnection != null) {
      $request  = "UPDATE styRoleRight SET ";
  ...
  public static function save(StyRoleRightStorData $data, DistriXPDOConnection $inDbConnection)
  {
    $insere = false; $id = 0;
    if ($data->getId() > 0) {
      $id = $data->getId();
  ...
  public static function delete(int $id, DistriXPDOConnection $inDbConnection)
  {
    ...
    if ($inDbConnection != null) {
      $request  = "DELETE FROM styRoleRight";
      $request .= " WHERE id = :id";
      $stmt = $inDbConnection->prepare($request);
      $stmt->execute(['id'=> $id]);
      $insere = is_null($inDbConnection->errorInfo()[2]); // If there is no DB error
  ...
  public static function create(StyRoleRightStorData $data, DistriXPDOConnection $inDbConnection)
  {
    $insere = false;
    $request = "";

    if ($inDbConnection != null) {
      $request  = "INSERT INTO styRoleRight(";
      $request .= "idstyrole,idstyapplication,idstymodule,idstyfunctionality,sumofrights,timestamp)";
      $request .= " VALUES(";
      $request .= ":idstyrole,";
