...
if (!class_exists("DistriXStyModuleData", false)) {
  class DistriXStyModuleData extends DistriXSvcAppData
  {
    ...
    public function getStyFunctionalities(){return $this->styFunctionalities;}
    ...
    public function setStyFunctionalities($styFunctionalities){$this->styFunctionalities = $styFunctionalities;}
