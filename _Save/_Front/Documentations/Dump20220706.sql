...
--
-- Hôte : localhost:8889
-- Généré le : mer. 06 juil. 2022 à 15:17
...
INSERT INTO `exercise` (`id`, `idusercoach`, `code`, `name`, `idexercisetype`, `linktopictureinternal`, `linktopictureexternal`, `size`, `type`, `description`, `elemstate`, `timestamp`) VALUES
(1, 1, 'EXO1', 'Exercise 1', 1, '', '', 0, '', 'desc exo 1', 0, 0),
(2, 1, 'EXO2', 'Exercise 2', 2, '', '', 0, '', 'desc exo 2', 0, 0);
