...
//=============================================================================
  ...
  const SELECT = 'SELECT id,idstyuser,idstyrole,timestamp';
  ...
  public static function findByIndUser(StyUserRoleStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    ...
    if ($inDbConnection != null) {
      ...
      $stmt = $inDbConnection->prepare($request);
      $stmt->execute(['index0'=>  $dataIn->getIdStyUser()]);
  ...
  // End of findByIndUser

  public static function getListByRole(StyUserRoleStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $list = [];
    ...
    if ($inDbConnection != null) {
      ...
      $stmt = $inDbConnection->prepare($request);
      $stmt->execute(['index0'=>  $dataIn->getIdStyRole()]);
      if (self::SHOW_FIND_REQUEST) {
        echo self::DEBUG_ERROR . $inDbConnection->errorInfo()[2] . self::BREAK . $stmt->debugDumpParams() . self::DOUBLE_BREAK;
      }
      if ($stmt->rowCount() > 0) {
  ...
  // End of getListByRole

  public static function findByIndUserRole(StyUserRoleStorData $dataIn, DistriXPDOConnection $inDbConnection)
  {
    $request = "";
    $data = new StyUserRoleStorData();
  ...
  public static function create(StyUserRoleStorData $data, DistriXPDOConnection $inDbConnection)
  {
    ...
    if ($inDbConnection != null) {
      ...
      $request .= "idstyuser,idstyrole,timestamp)";
      $request .= " VALUES(";
      $request .= ":idstyuser,";
      $request .= ":idstyrole,";
      $request .= ":timestamp)";
