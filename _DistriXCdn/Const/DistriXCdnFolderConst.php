<?php
if (!defined('DISTRIX_CDN_GROUP_IMAGES')) {
  define("DISTRIX_CDN_GROUP_IMAGES", "DISTRIX_CDN_GROUP_IMAGES");
}
...
if (!defined('DISTRIX_CDN_FOLDER_LANGUAGES')) {
  define("DISTRIX_CDN_FOLDER_LANGUAGES", "languages");
}
