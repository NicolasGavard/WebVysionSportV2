...
if (!class_exists('DistriXStySvcCaller', false)) {
	class DistriXStySvcCaller extends DistriXSvcCaller
	{
		/* SSL Keys Locations */
		...
		const CLIENT_DIR_DEV     = "DISTRIX_STY_SERVICES/DistriX";
		const CLIENT_DIR_INT     = "StyServices";
		const CLIENT_DIR_VER     = "StyServices";
		const CLIENT_DIR_VAL     = "StyServices";
		const CLIENT_DIR_PROD    = "StyServices";
		...
		const CLIENT_DIR_DEV_TIMEOUT              = "DISTRIX_STY_SERVICES/DistriX";
