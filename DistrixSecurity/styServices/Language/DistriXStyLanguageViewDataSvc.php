...
if (is_null($dbConnection->getError())) {
  ...
  $styLanguagestor = StyLanguageStor::read($data->getId(), $dbConnection);
  $infoLanguage    = DistriXSvcUtil::setData($styLanguagestor, "DistriXStyLanguageData");
...
if ($errorData != null) {
  $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "ListLanguages", $dataSvc->getMethodName(), basename(__FILE__));
  $dataSvc->addErrorToResponse($errorData);
}
$dataSvc->addToResponse("ViewLanguage", $infoLanguage);
