...
if ($dataSvc->getMethodName() == "RestoreLanguage") {
  ...
  if (is_null($dbConnection->getError())) {
    if ($dbConnection->beginTransaction()) {
      ...
      $insere           = StyLanguageStor::restore($styLanguagestor, $dbConnection);
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "RestoreLanguage", $dataSvc->getMethodName(), basename(__FILE__));
