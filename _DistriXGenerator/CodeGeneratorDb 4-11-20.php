...
// Get List
        fputs($f,'  public static function getList($all, $inDbConnection) {'."\r\n");
        fputs($f,'    $request = "";'."\r\n");
...
// Read
        fputs($f,"\r\n");
        fputs($f,'  public static function read($id, $inDbConnection) {'."\r\n");
        fputs($f,'    $request = "";'."\r\n");
        fputs($f,'    $data = new '.$dbDataObjectName.'();'."\r\n");
        fputs($f,"\r\n");
        fputs($f,'    if ($inDbConnection != null) {'."\r\n");
...
// Update
        fputs($f,"\r\n");
        fputs($f,'  public static function update($data, $inDbConnection) {'."\r\n");
        ...
        fputs($f,'      $inDbConnection->exec($request);'."\r\n");
        fputs($f,'      if (is_null($inDbConnection->errorInfo()[2])) { // If there is no DB error'."\r\n");
        fputs($f,'        $insere = true;'."\r\n");
        fputs($f,'      } else {'."\r\n");
        fputs($f,'        echo "<p>------------------<br>DB Error: " . $inDbConnection->errorInfo()[2] . "<br>------------------<br>$request<br><br>";'."\r\n");
        fputs($f,'      }'."\r\n");
        fputs($f,'    }'."\r\n");
...
// save
        fputs($f,"\r\n");
        fputs($f,'  public static function save($data, $idUser, $inDbConnection) {'."\r\n");
...
// remove
        fputs($f,"\r\n");
        fputs($f,'  public static function remove($data, $idUser, $inDbConnection) {'."\r\n");
        fputs($f,'    $insere = false;'."\r\n");
        fputs($f,'    if ($data->getId() > 0) {'."\r\n");
        fputs($f,'      $userPazziStorData = self::read($data->getId(), $inDbConnection);'."\r\n");
        ...
        fputs($f,'      $insere = self::update($userPazziStorData, $inDbConnection);'."\r\n");
        fputs($f,'    }'."\r\n");
        fputs($f,'    return $insere;'."\r\n");
        fputs($f,'  }'."\r\n");
...
// restore
        fputs($f,"\r\n");
        fputs($f,'  public static function restore($data, $idUser, $inDbConnection) {'."\r\n");
        fputs($f,'    $insere = false;'."\r\n");
        fputs($f,'    if ($data->getId() > 0) {'."\r\n");
        fputs($f,'      $userPazziStorData = self::read($data->getId(), $inDbConnection);'."\r\n");
...
// Create
        fputs($f,"\r\n");
        fputs($f,'  public static function create($data, $inDbConnection) {'."\r\n");
        fputs($f,'    $insere = false;'."\r\n");
        fputs($f,'    $request = "";'."\r\n");
