...
CREATE TABLE `nutritional` (
  ...
  `iscalorie` tinyint unsigned NOT NULL,
  `isproetin` tinyint unsigned NOT NULL,
  `isglucide` tinyint unsigned NOT NULL,
  `islipid` tinyint unsigned NOT NULL,
  `isvitamin` tinyint unsigned NOT NULL,
  `istraceelement` tinyint unsigned NOT NULL,
  `ismineral` tinyint unsigned NOT NULL,
