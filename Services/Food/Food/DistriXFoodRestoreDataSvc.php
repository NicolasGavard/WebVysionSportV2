...
if ($dataSvc->isAuthorized()) {
  ...
  if (is_null($dbConnection->getError())) {
    if ($dbConnection->beginTransaction()) {
      ...
      $insere                 = FoodStor::restore($foodstor, $dbConnection);
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("Distrix", "RestoreFood", $dataSvc->getMethodName(), basename(__FILE__));
