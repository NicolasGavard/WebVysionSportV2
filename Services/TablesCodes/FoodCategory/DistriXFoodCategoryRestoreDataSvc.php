...
// RestoreFoodCategory
if ($dataSvc->getMethodName() == "RestoreFoodCategory") {
  $dbConnection   = null;
  $errorData      = null;
  $insere         = false;
  ...
  if (is_null($dbConnection->getError())) {
    if ($dbConnection->beginTransaction()) {
      ...
      $insere         = CategoryStor::restore($scoreNutristor, $dbConnection);
  ...
  if ($errorData != null) {
    $errorData->setApplicationModuleFunctionalityCodeAndFilename("Distrix", "RestoreFoodCategory", $dataSvc->getMethodName(), basename(__FILE__));
