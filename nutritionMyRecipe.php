  ...
  <div class="content-wrapper" style="background:#69a7c5; padding: 1.5rem 1.5rem 1.5rem 1.5rem;">
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Mes diètes en cours</h4>
            
            <div class="row">
              <div class="col-md-9">
                <form class="forms-sample" style="margin-bottom: -30px;">
                  <div class="form-group row">
                    <label for="exampleInputUsername2" class="col-sm-2 col-form-label">Elève</label>
                    <div class="col-sm-10">
            ...
            <div class="table-responsive">          
              <table class="table table-striped">
                <thead>
                  <tr>
                    <th width=5%>Image</th>
                    <th width=10%>Elève</th>
                    <th width=40%>Durée</th>
                    <th width=5%>Status</th>
                    <th width=5%>Tags</th>
                    <th width=5%>Avancement</th>
