...
if (!class_exists('DistriXWatcherSvcCaller', false)) {
	class DistriXWatcherSvcCaller extends DistriXSvcCaller
	{
		/* SSL Keys Locations */
		...
		const CLIENT_DIR_DEV     = "DistriX";
		const CLIENT_DIR_INT     = "DistriX";
		const CLIENT_DIR_VER     = "DistriX";
		const CLIENT_DIR_VAL     = "DistriX";
		const CLIENT_DIR_PROD    = "DistriX";
		...
		const CLIENT_DIR_DEV_TIMEOUT              = "DistriX";
