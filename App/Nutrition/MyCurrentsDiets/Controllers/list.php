...
if (!empty($_POST) && isset($_POST)) {
  ...
  $dietTemplateCaller = new DistriXServicesCaller();  $dietTemplateCaller->setServiceName("App/Nutrition/MyTemplatesDiets/Services/DistriXNutritionMyTemplatesDietsListDataSvc.php");
