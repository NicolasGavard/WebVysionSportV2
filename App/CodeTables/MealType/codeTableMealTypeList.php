<?php
  ...
  // If ($user->->getIdLanguage() == 2) $i18cdlangue = 'EN';
	...
	include('i18/'.$i18cdlangue.'/codeTableMealTypeList'.$i18cdlangue.'.php');
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="pull-right">
              ...
              <button type="button" class="btn btn-primary AddNewMealType" data-toggle="modal" data-target="#modalAddMealType"><i class="fa fa-plus"></i>&nbsp;<?php echo $page_all_add; ?></button>
        		</div>
					</div>
          
          <div class="pb-20"></div>
          <div class="pb-20">
						<table id="MealTypeTable" class="display responsive nowrap" width="100%">
							<thead>
								<tr>                 
      ...
      <div class="modal fade" id="modalAddMealType" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body text-center font-18">
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddMealTypeFormCode" id="AddMealTypeFormCode" type="text" code="codeShort" placeholder="<?php echo $page_code; ?>">
                ...
                <div class="col-md-8 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddMealTypeFormName" id="AddMealTypeFormName" type="text" code="mealTypeName" placeholder="<?php echo $page_name; ?>">
              ...
              <div class="padding-bottom-20 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnAddMealType" id="btnAddMealType"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_add; ?></button>
                  <button type="button" class="btn btn-primary btnUpdateMealType" id="btnUpdateMealType"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_update; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      ?>
      <script src="codeTableMealTypeList.js?v=<?php echo APP_VERSION;?>"></script>
  </body>
</html>
