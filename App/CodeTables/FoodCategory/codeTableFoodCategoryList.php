...
include('i18/'.$i18cdlangue.'/codeTableFoodCategoryList'.$i18cdlangue.'.php');
...
?>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pb-20"></div>
          <div class="pb-20">
						<table id="FoodCategoryTable" class="display responsive nowrap" width="100%">
							<thead>
								<tr>                 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-body text-center font-18">
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddFoodCategoryFormCode" id="AddFoodCategoryFormCode" type="text" code="codeShort" placeholder="<?php echo $page_code; ?>">
                ...
                <div class="col-md-8 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddFoodCategoryFormName" id="AddFoodCategoryFormName" type="text" code="foodCategoryName" placeholder="<?php echo $page_name; ?>">
              ...
              <div id="foodCategoryLanguages"></div>
              ...
              <div class="padding-bottom-20 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnUpdateFoodCategory" id="btnUpdateFoodCategory"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_update; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      ?>
      <script src="codeTableFoodCategoryList.js?v=<?php echo APP_VERSION;?>"></script>
  </body>
</html>
