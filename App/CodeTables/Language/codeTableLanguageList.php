...
?>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pb-20"></div>
          <div class="pb-20">
						<table id="LanguageTable" class="display responsive nowrap" width="100%">
							<thead>
								<tr>                 
            ...
            <div class="modal-body text-center font-18">
              ...
              <div class="padding-bottom-30 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnUpdateLanguage" id="btnUpdateLanguage"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_update; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      ?>
      <script src="codeTableLanguageList.js?v=<?php echo APP_VERSION;?>"></script>
  </body>
</html>
