...
$(function () {
  ...
  $(".AddNewNutritional").on("click", function () {
    ...
    $.map(languages, function (language, languageKey) {
      ...
      html += '      <div class="form-group">';
      html +=
        '        <input class="form-control AddNutritionalFormLanguageName" type="text" name="nutritionalLanguageName' +
        language.id +
        '" placeholder="' +
        nameTranslatedTxt +
        '">';
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.ConfirmSave) {
            ...
            setTimeout(function () {
              window.location.href = "./codeTableNutritionalList.php";
            }, 800);
          } else {
    ...
    $.map(dataTableData, function (val, key) {
      if (val.elemState == elemState) {
        ...
        line +=
          ...
          '       <a class="dropdown-item ' +
          actionBtnRestore +
          '" data-toggle="modal" data-target="#modalRest"        onclick="RestNutritional(\'' +
          val.id +
          "', '" +
          val.name +
    ...
    success: function (data) {
      ...
      $.map(languages, function (language, languageKey) {
        ...
        html +=
          ...
          className +
          ' AddNutritionalFormLanguageName" type="text" name="nutritionalLanguageName' +
          language.id +
          '" value="' +
          updateName +
          '" placeholder="' +
