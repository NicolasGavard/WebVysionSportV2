<?php
  ...
  // If ($user->->getIdLanguage() == 2) $i18cdlangue = 'EN';
	...
	include('i18/'.$i18cdlangue.'/codeTableNutritionalList'.$i18cdlangue.'.php');
...
?>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pb-20"></div>
          <div class="pb-20">
						<table id="NutritionalTable" class="display responsive nowrap" width="100%">
							<thead>
								<tr>                 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-body text-center font-18">
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddNutritionalFormCode" id="AddNutritionalFormCode" type="text" code="codeShort" placeholder="<?php echo $page_code; ?>">
                ...
                <div class="col-md-8 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control AddNutritionalFormName" id="AddNutritionalFormName" type="text" code="nutritionalName" placeholder="<?php echo $page_name; ?>">
              ...
              <div id="nutritionalLanguages"></div>
              ...
              <div class="padding-bottom-20 row" style="margin: 0 auto;">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary btnUpdateNutritional" id="btnUpdateNutritional"><i class="fa fa-check"></i>&nbsp;<?php echo $page_all_update; ?></button>
                </div>
              </div>
            </div>
          </div>
      ...
      ?>
      <script src="codeTableNutritionalList.js?v=<?php echo APP_VERSION;?>"></script>
  </body>
</html>
