...
if (is_null($dbConnection->getError())) {
  if ($dbConnection->beginTransaction()) {
    ...
    $insere = ExerciseStor::remove($exerciseStorData, $dbConnection);
    if ($insere) {
      $dbConnection->commit();
    } else {
...
if ($errorData != null) {
  $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "DelCurrentExercise", $dataSvc->getMethodName(), basename(__FILE__));
