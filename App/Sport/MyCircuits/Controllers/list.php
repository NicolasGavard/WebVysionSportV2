...
// if (!empty($_POST) && isset($_POST)) {
  ...
  $distriXCircuitTemplateData->setIdUserCoach($infoProfil->getId());
    
  // CALL
  $circuitCaller = new DistriXServicesCaller();
  $circuitCaller->setServiceName("App/Sport/MyCircuits/Services/DistriXSportMyCircuitsTemplateListDataSvc.php");
