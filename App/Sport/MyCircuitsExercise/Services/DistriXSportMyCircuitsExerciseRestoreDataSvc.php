...
if (is_null($dbConnection->getError())) {
  if ($dbConnection->beginTransaction()) {
    ...
    $insere                             = CircuitExerciseStor::restore($exerciseStorData, $dbConnection);
    if ($insere) {
      $dbConnection->commit();
    } else {
...
if ($errorData != null) {
  $errorData->setApplicationModuleFunctionalityCodeAndFilename("DistrixSty", "RestoreCurrentCircuitExercise", $dataSvc->getMethodName(), basename(__FILE__));
