...
CREATE TABLE `circuitexercise` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `indcodeunique` (`idcircuittemplate`,`idexercise`) USING BTREE
) ENGINE=InnoDB COMMENT='Circuit Exercises' DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;

INSERT INTO circuitexercise(id,idcircuittemplate,idexercise,elemstate,timestamp) VALUES 
(1,1,1,0,0),
(2,2,2,0,0),
(3,3,3,0,0),
(4,4,4,0,0);
