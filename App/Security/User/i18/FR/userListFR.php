<?php
  ...
  $page_status          = "Statut";
  $page_action          = "Actions";
  $page_add_title       = "Ajouter un utilisateur";
  $page_update_title    = "Modifier l'utilisateur";
  $page_delete_title    = "Supprimer l'utilisateur";
  $page_restore_title   = "Restaurer l'utilisateur";
