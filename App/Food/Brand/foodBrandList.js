  ...
  if (name != "") {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        setTimeout(function () {
          window.location.href = "./foodBrandList.php";
        }, 800);
      },
      error: function (data) {
  ...
  $.map(dataTableData, function (val, key) {
    if (val.elemState == elemState) {
      ...
      const line =
        ...
        '       <a class="dropdown-item"                      data-toggle="modal" data-target="#modalAddBrand" id="ViewBrand' +
        val.id +
        '" onclick="ViewBrand(\'' +
        val.id +
        ...
        actionBtnDelete +
        '"  data-toggle="modal" data-target="#modalDel"        onclick="DelBrand(\'' +
        val.id +
        "', '" +
        val.name +
        ...
        '       <a class="dropdown-item ' +
        actionBtnRestore +
        '" data-toggle="modal" data-target="#modalRest"       onclick="RestBrand(\'' +
        val.id +
        "', '" +
        val.name +
