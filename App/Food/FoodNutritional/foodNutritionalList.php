        ...
        <div class="row">
          <div class="col-md-12 col-sm-6">
            <div class="form-group">
              <label><?php echo $page_nutritional; ?></label>
              <select class="custom-select2 form-control" id="listNutritionalsNotApply" name="idNutritional" style="width: 100%; height: 38px;">  
                <option value="0"><?php echo $page_all_choice; ?></option>
              </select>
              <div class="form-control-feed back danger-name has-danger d-none" style='font-size: 14px;'><?php echo $errorData_txt_nutritional; ?> </div>
            </div>
          </div>
          <div class="col-md-12 col-sm-6">
            <div class="form-group">
