  ...
  $.map(dataTableData, function (val, key) {
    if (val.elemState == elemState) {
      ...
      const line =
        ...
        '       <a class="dropdown-item"                      data-toggle="modal" data-target="#modalAddFoodWeight" onclick="ViewFoodWeight(\'' +
        val.id +
        "', '" +
        val.name +
        ...
        actionBtnDelete +
        '"  data-toggle="modal" data-target="#modalDel"           onclick="DelFoodWeight(\'' +
        val.id +
        "', '" +
        val.weight +
        " " +
        ...
        '       <a class="dropdown-item ' +
        actionBtnRestore +
        '" data-toggle="modal" data-target="#modalRest"          onclick="RestFoodWeight(\'' +
        val.id +
        "', '" +
        val.weight +
        " " +
