  ...
  <div class="pd-20 card-box mb-30">				
    ...
    <div class="pb-20">
      <table id="FoodWeightTable" class="display responsive nowrap" width="100%">
        <thead>
          <tr>                 
            <th width="20%" class="table-plus"><span><?php echo $page_weight; ?></span></th>
            <th width="70%"><span><?php echo $page_type; ?></span></th>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            <div class="form-group">
              ...
              <select class="custom-select2 form-control" id="listWeightsNotApply" name="idWeight" style="width: 100%; height: 38px;">  
