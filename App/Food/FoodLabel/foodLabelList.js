  ...
  $.map(dataTableData, function (val, key) {
    if (val.elemState == elemState) {
      ...
      const line =
        ...
        actionBtnDelete +
        '"  data-toggle="modal" data-target="#modalDel"   onclick="DelFoodLabel(\'' +
        val.id +
        "', '" +
        val.name +
        ...
        '       <a class="dropdown-item ' +
        actionBtnRestore +
        '" data-toggle="modal" data-target="#modalRest"  onclick="RestFoodLabel(\'' +
        val.id +
        "', '" +
        val.name +
