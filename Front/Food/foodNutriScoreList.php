<?php
  ...
  $international  = 'Food/foodNutriScoreList';
  $i18cdlangue    = 'FR';
...
?>
	...
	<div class="main-container">
            ...
            <div class="modal-body text-center font-18">
              ...
              <div class="dropzoneImage padding-bottom-30 col-md-12 col-sm-12 d-none">
                <div class="profile-photo">
                  <img src="" alt="" style="max-width:180px; max-height:180px; border-radius: 10px;" class="avatar-photo avatar-NutriScore">
                </div>
      ...
      <script src="../../jsWebVysionSport/Food/foodNutriScore.js"></script>
  </body>
</html>