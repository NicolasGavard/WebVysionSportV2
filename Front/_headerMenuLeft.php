...
<div class="left-side-bar">
  <div class="brand-logo">
    <a href="main.php">
      <img src="<?php echo $path; ?>/images/WebVysionSport.png" alt="" class="light-logo" style="max-width: 75px;">
    </a>
        ...
        <?php if ($hasSport) { ?>
          <li class="dropdown">
            <a href="javascript:;" class="dropdown-toggle">
              ...
              &nbsp;<img src="<?php echo $path; ?>/vendors/images/coming-soon.png" alt="" width="25">
            </a>
            <ul class="submenu">
              <li><a href="#">1</a></li>
              <li><a href="#">2</a></li>
              ...
              <?php if ($hasFood) { ?>
                <li class="dropdown <?php echo $show2; ?>">
                  ...
                  <ul class="submenu child">
                    <?php if ($hasRight_FOOD_FOOD)        { ?><li <?php echo $navActiveMenuFoodFood ?>><a class="nav-link" href="Nutrition/Food/foodFoodList.php"><?php echo $menu_food_food_list; ?></a></li><?php } ?>
                    <?php if ($hasRight_FOOD_BRAND)       { ?><li <?php echo $navActiveMenuFoodBrand ?>><a class="nav-link" href="Nutrition/Food/foodBrandList.php"><?php echo $menu_food_brand_list; ?></a></li><?php } ?>
                    <?php if ($hasRight_FOOD_ECO_SCORE)   { ?><li <?php echo $navActiveMenuFoodEcoScore ?>><a class="nav-link" href="Nutrition/Food/foodEcoScoreList.php"><?php echo $menu_food_ecoScore_list; ?></a></li><?php } ?>
                    <?php if ($hasRight_FOOD_NOVA_SCORE)  { ?><li <?php echo $navActiveMenuFoodNovaScore ?>><a class="nav-link" href="Nutrition/Food/foodNovaScoreList.php"><?php echo $menu_food_novaScore_list; ?></a></li><?php } ?>
                    <?php if ($hasRight_FOOD_NUTRI_SCORE) { ?><li <?php echo $navActiveMenuFoodNutriScore ?>><a class="nav-link" href="Nutrition/Food/foodNutriScoreList.php"><?php echo $menu_food_nutriScore_list; ?></a></li><?php } ?>
                    <?php if ($hasRight_FOOD_LABEL)       { ?><li <?php echo $navActiveMenuFoodLabel ?>><a class="nav-link" href="Nutrition/Food/foodLabelList.php"><?php echo $menu_food_label_list; ?></a></li><?php } ?>
                  </ul>
                </li>
              <?php } ?>
            </ul>
