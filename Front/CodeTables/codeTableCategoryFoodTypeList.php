<?php
	session_start();
  $international  = 'CodeTables/codeTableCategoryFoodTypeList';
  $i18cdlangue    = 'FR';
...
?>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
          ...
          <div class="pb-20">
						<table class="table stripe hover nowrap" id="datatable">
							<thead>
								<tr>                 
                  <th width="30%" class="table-plus"><span><?php echo $page_code; ?></span></th>
                  <th width="40%"><span><?php echo $page_name; ?></span></th>
                  <th width="20%"><span><?php echo $page_translation; ?></span></th>
                  <th width="10%" class="datatable-nosort"><span><?php echo $page_action; ?></span></th>
								</tr>
							</thead>
							<tbody id="listCategoryFoodTypesTbody">            
							</tbody>
						</table>
					</div>
				</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-body text-center font-18">
              ...
              <div class="row">
                <input class="form-control AddCategoryFoodTypeFormIdCategoryFoodType" type="hidden" name="id"         value="0">
                <input class="form-control AddCategoryFoodTypeFormTimestamp"      type="hidden" name="timestamp"  value="0">
                <input class="form-control AddCategoryFoodTypeFormStatut"         type="hidden" name="elemState"  value="0">
              
                <div class="col-md-12 col-sm-12">
                  <div class="form-group">
                    <label><?php echo $page_name; ?></label>
                    <input class="form-control AddCategoryFoodTypeFormName" type="text" name="name" placeholder="<?php echo $page_name; ?>">
      ...
      <script src="../../jsWebVysionSport/CodeTables/codeTableCategoryFoodType.js"></script>
  </body>
</html>
