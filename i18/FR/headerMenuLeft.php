<?php
  ...
  $menu_nutrition_myDiet        = "Mes diètes en cours";
  $menu_nutrition_myTempletDiet = "Mes templates de diètes";
  ...
  $menu_profil_activities = "Activité(s)";
  $menu_profil_faq        = "FAQ";
  $menu_profil_logout     = "Déconnexion";
