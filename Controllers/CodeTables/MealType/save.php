...
list($foodType, $jsonError) = DistriXCodeTableMealTypeData::getJsonData($_POST);
list($foodTypeNames, $jsonError) = DistriXCodeTableMealTypeNameData::getJsonArray($foodType->getNames());
...
if (DistriXLogger::isLoggerRunning(__DIR__ . "/../../DistriXLoggerSettings.php", "Security_MealType")) {
  ...
  $logInfoData->setLogApplication("DistriXMealTypeSaveDataSvc");
  $logInfoData->setLogFunction("SaveMealType");
