...
// DATA
include(__DIR__ . "/../../Nutrition/Data/DistriXNutritionCurrentDietData.php");
// Error
...
if (isset($_POST)) {
  ...
  $servicesCaller->setServiceName("DistriXServices/Nutrition/CurrentDiet/DistriXNutritionMyCurrentsDietsDeleteDataSvc.php");
